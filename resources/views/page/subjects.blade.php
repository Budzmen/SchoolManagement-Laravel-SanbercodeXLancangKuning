...
@endif
  ...
  <div class="col-sm-4">
    <div class="card">
      ...
      <div class="card-body ">
        <p class="card-text">Guru Bidang Studi: {{$item->teacher->name}}</p>
        <p class="card-text"> Murid Bidang Studi: {{$item->student->name}}</p>
        <div class="d-flex justify-content-between align-items-center">
          <a href="/subjects/{{$item->id}}/edit" class="btn btn-outline-warning"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
